...
class Revisiones(models.Model):
    ...
    guia_mantenimiento = models.CharField(max_length=300, blank=True, null=True)
...
class ListaItems(models.Model):
    ...
    def __str__(self):
        return self.descripcion + " - " + self.familia
...
class Cotizaciones(models.Model):
    id = models.BigAutoField(primary_key=True)
    no_orden = models.CharField(max_length=50, blank=True, null=True)
    item = models.ForeignKey(Items, models.SET_NULL, blank=True, null=True)
    repuesto = models.CharField(max_length=250, blank=True, null=True)
    costo_repuesto = models.DecimalField(max_digits=18, decimal_places=2, blank=True, null=True)
    costo_mano_obra = models.DecimalField(max_digits=18, decimal_places=2, blank=True, null=True)
    subtotal = models.DecimalField(max_digits=18, decimal_places=2, blank=True, null=True)
    iva = models.DecimalField(max_digits=18, decimal_places=2, blank=True, null=True)
    monto_iva = models.DecimalField(max_digits=18, decimal_places=2, blank=True, null=True)
    total = models.DecimalField(max_digits=18, decimal_places=2, blank=True, null=True)
    fecha_hora_fin = models.DateTimeField(blank=True, null=True, auto_now_add=True)
    fecha_hora_actualizacion = models.DateTimeField(blank=True, null=True, auto_now=True)
...
class VRevisionesLimpias(models.Model):
    no_orden = models.CharField(max_length=25, primary_key=True)
