...
class NotificacionCorreo:
    ...
    def render(self, context):
        html = render_to_string("seguimientolite_mazda_col/correo.html", context)
        return html

    def enviar(self):
        try:
            asunto_email = self.asunto
    ...
    try:
        for group in groups:
            ...
            payload = {
                ...
                "icon": "https://upload.wikimedia.org/wikipedia/commons/0/0b/Citroen-logo-2009.png",
            }
    ...
    for element in elements:
        try:
            ...
            try:
                ...
                pass
        logger.info("FILEPOND ACTUALIZADO")
